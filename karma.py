...
print(f"Booting {Fore.RED}₭₳Ɽ₥₳ {Fore.RESET}Bot")
time.sleep(0.4)
print(f"{Fore.RED}25%")
time.sleep(0.6)
...
time.sleep(1.1)
print(f"{Fore.LIGHTBLUE_EX}₭₳Ɽ₥₳ Bot booted")
time.sleep(1)
...
async def on_ready():
    print(f'''
{Fore.RED} _                       {Fore.BLUE} _ 
{Fore.RED}| |_ ___ ___ _____ ___ ! {Fore.BLUE}| |_ ___ ___ _____ ___ ! 
{Fore.RED}| '_| .'|  _|     | .'|  {Fore.BLUE}| '_| .'|  _|     | .'|  
{Fore.RED}|_,_|__,|_| |_|_|_|__,|  {Fore.BLUE}|_,_|__,|_| |_|_|_|__,|
{Fore.WHITE}                            Made by {Fore.YELLOW}NotHealer  
{Fore.WHITE}Check out the github page for updates: {Fore.LIGHTBLUE_EX}https://github.com/NotHealer/Karma/           
